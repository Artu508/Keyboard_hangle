...
import kr.jung.keyboard_hangle.ListAdapterMain;
import kr.jung.keyboard_hangle.ListItemMain;
...
public class MainSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Drawable[] product_icon =
                {
                        ContextCompat.getDrawable(this,R.drawable.ic_language_black),
                        ContextCompat.getDrawable(this, R.drawable.ic_color_lens_black),
                        ContextCompat.getDrawable(this, R.drawable.ic_chrome_reader_mode_black),
                        ContextCompat.getDrawable(this, R.drawable.ic_adb_black),
                };
